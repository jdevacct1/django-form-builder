"""
Base settings for django_form_builder project.
...
MIDDLEWARE = [
    "corsheaders.middleware.CorsMiddleware",            # put high
...
ROOT_URLCONF = 'django_form_builder.urls'
...
WSGI_APPLICATION = 'django_form_builder.wsgi.application'
